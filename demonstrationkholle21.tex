...
Soit P scindé :  \\
$P= \lambda \prod_{k=1}^r (X-\alpha)^{m_k}$ avec $\lambda \in \mathbb K^*,r \in \mathbb N^*,(\alpha_1,...,\alpha_r) \in \mathbb K^r$, racines distinctes de multiplicités $(m_1,....,m_r)$ alors \\
