...
donc : \\
$ \left\{\begin{array}{l} \langle X^2-p_F(X^2),1 \rangle=0 \\
\langle X^2-p_F(X^2),X \rangle=0 \end{array} \right .$ \\ \\
$ \left\{\begin{array}{l} \langle aX+b,1 \rangle = \langle X^2,1 \rangle  \\
\langle aX+b,X \rangle = \langle X^2,X \rangle \end{array} \right. $  \\ \\
$ \left\{\begin{array}{l}\langle X,1 \rangle a + \langle 1,1 \rangle b= \langle X^2,1 \rangle \\
\langle X,X \rangle a + \langle 1,X \rangle b= \langle X^2,X \rangle \end{array} \right.$ \\ \\
$ \left\{\begin{array}{l}\frac{1}{2} a +b = \frac{1}{3} \\
\frac{1}{3}a +\frac{1}{2}b =\frac{1}{4} \end{array} \right. $ \\ \\
$\begin{pmatrix}
\frac{1}{2} & 1 \\ \\
\frac{1}{3} & \frac{1}{2}
\end{pmatrix}
...
On obtient : \\
$m= \frac 1 5 - [ \frac 1 3 t^3 - \frac 1 6 t^2 + \frac 1 {36} t]_0^1$ \\
...
f est un endomorphisme injectif d'un espace de dimension finie donc f est bijectif (corrolaire du théorème du rang) \\
...
\textcolor{green}{Propriété :} soit $f \in \mathcal L(E)$ Les propositions suivantes sont équivalentes : \\
\textcolor{green}{1)} $\forall \vec x \in E, \| f(\vec x) \| = \| \vec x \|$ \\
\textcolor{green}{2)} $\forall (\vec x, \vec y) \in E^2,\langle f(\vec x), f(\vec y) \rangle =\langle \vec x, \vec y \rangle $ \\
\textcolor{red}{Démonstration :} \\
